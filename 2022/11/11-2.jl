...
function work(filepath::String)
    ...
    lcm = prod(map(m->m.testDivisor, monkeys)) # Product because they are prime (we assume for input aswell)
    ...
    for _ in 1:10000
        ...
        for monkey in monkeys
            ...
            foreach(monkey.items) do item
                ...
                worry = worry % lcm # Congruens, LCM, needed help: https://aoc.just2good.co.uk/2022/11
                # println(worry)
                monkey.inspection += 1
